...
from .utils import calcula_total, calcula_equilibrio_tinanceiro
...
def home(request):
    ...
    percentual_gastos_essenciais, percentual_gastos_nao_essenciais = calcula_equilibrio_tinanceiro()
